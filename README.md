...
A smart application using **Machine Learning** to classify waste and provide **sustainable disposal methods**.  
🔹 **Tech Stack:** Python, TensorFlow, Google Maps API, Firebase  
